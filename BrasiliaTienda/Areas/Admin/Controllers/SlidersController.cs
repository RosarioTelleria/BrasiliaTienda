...
namespace BrasiliaTienda.Areas.Admin.Controllers;
    ...
    public class SlidersController : Controller
    {
        ...
        [HttpGet]
        public IActionResult Editsliders(int? id)
        {
        ...
        public IActionResult Editsliders(Slider slider)
        {
        ...
        if (sliderDesdeDb==null)
            {
                return Json(new {success= false , message="Error en el borrado del slider"});

            }
            _contenedorTrabajo.Slider.Remove(sliderDesdeDb);
            _contenedorTrabajo.Save();
            return Json(new { success = true, message = "Sliders borrado correctamente" });
        }
